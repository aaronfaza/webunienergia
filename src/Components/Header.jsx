...
export default function Header() {
  ...
  return (
    <header
      ...
      role="banner"
      aria-label="Barra de navegación principal de UNIENERGÍA"
    >
      <div className="flex items-center justify-between px-6 md:px-12 py-4">
        ...
        <a
          ...
          aria-label="Ir al inicio de UNIENERGÍA"
        >
          <img
            src="/logo1.png"
            alt="Logo corporativo de UNIENERGÍA"
        ...
        <div className="flex items-center gap-4">
          <a
            href="#contacto"
            className="hidden md:inline-block bg-gradient-to-r from-blue-900 via-blue-900 to-blue-900 text-white px-6 py-2 rounded-full shadow-lg hover:scale-105 transition-transform duration-300 focus:outline-none focus:ring-2 focus:ring-blue-800"
